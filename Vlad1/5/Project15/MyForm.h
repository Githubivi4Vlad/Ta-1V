...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(77, 213);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(12, 159);
			...
			this->label3->Text = L"¬ведите  : ";
			// 
			// label4
			// 
			this->label4->AutoSize = true;
			this->label4->Location = System::Drawing::Point(120, 130);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(110, 159);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(211, 159);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		double p, q, r, l, k, res1, res2, res3;
